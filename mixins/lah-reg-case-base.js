export default {
  ...
  computed: {
    ...
    queryDataUrl () {
      return `http://${this.webapIp}:9080/Land${this.site}/CAS/CCD01/CCD0103.jsp?rm01=${this.year}&rm02=${this.code}&rm03=${this.number}`
    },
    queryStatusUrl () {
      return `http://${this.webapIp}:9080/Land${this.site}/CAS/CCD02/CCD0202.jsp?year=${this.year}&word=${this.code}&code=${this.number}&sdlyn=N&RM90=`
    }
  },
  watch: {
