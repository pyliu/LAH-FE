...
div(v-cloak)
  ...
  b-container(fluid v-cloak)
    ...
    b-card-group.row(deck)
      lah-index-card-link(:icon="['fas', 'traffic-light']" :to="isDevOffice ? '/inf/dashboard/HA' : '/inf/dashboard/HX'" no-body size="5x" icon-variant="danger" action="breath") {{ site }} 智慧戰情面板
